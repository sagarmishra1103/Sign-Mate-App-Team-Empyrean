...
classifier = Classifier("Model/Model/keras_model.h5", "Model/Model/labels.txt")# Load the trained Keras model and its labels
...
labels = ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N", "Q", "R", "s", "T", "U", "V", "W", "X", "Y", "Z"] # Define labels for gesture classification
